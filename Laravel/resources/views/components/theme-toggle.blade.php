<div>
    <input type="checkbox" name="light-switch" id="light-switch" class="sr-only light-switch" />
    <label
        class="flex items-center justify-center w-8 h-8 rounded-full cursor-pointer hover:bg-gray-100 lg:hover:bg-gray-200 dark:hover:bg-gray-700/50 dark:lg:hover:bg-gray-800"
        for="light-switch">
        <svg class="fill-current dark:hidden text-gray-500/80 dark:text-gray-400/80" width="16" height="16"
        ...
        <svg class="hidden fill-current dark:block text-gray-500/80 dark:text-gray-400/80" width="16" height="16"
            viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            <path
