<x-dashboard.layout>
    ...
    <form action="/dashboard/posts/{{ $post->slug }}" method="POST" class="col-span-8" enctype="multipart/form-data">
        @csrf
        @method('put')
        ...
        <div class="mb-2">
            ...
            <input type="text" name="title" id="title"
                ...
                placeholder="Type title" required="" value="{{ old('title', $post->title) }}">
            @error('title')
        ...
        <div class="mb-2">
            ...
            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white " for="file_input">Upload
                file</label>
            @if ($post->image)
                <img src="{{ asset('storage/' . $post->image) }}" class="block mb-2 img-preview max-h-[800px]">
            @else
                <img class="mb-2 img-preview max-h-[800px]">
            @endif
            <input
