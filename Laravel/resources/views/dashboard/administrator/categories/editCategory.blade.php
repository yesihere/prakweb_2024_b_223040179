<x-dashboard.layout>
    ...
    <form action="/dashboard/administrator/categories/{{ $category->slug }}" method="POST" class="col-span-5">
        @csrf
        @method('put')
        ...
        <div class="mb-2">
            ...
            <input type="text" name="name" id="category"
                ...
                placeholder="Type Category Name" required="" value="{{ old('category', $category->name) }}"
                autocomplete="off">
            @error('category')
        ...
        <div class="flex mb-2">
            <div class="flex items-center me-4">
                <input @if (old('color', $category->color) == 'blue') checked @endif id="blue-radio" type="radio" value="blue"
                    name="color"
            ...
            <div class="flex items-center me-4">
                <input @if (old('color', $category->color) == 'red') checked @endif id="red-radio" type="radio" value="red"
                    name="color"
            ...
            <div class="flex items-center me-4">
                <input @if (old('color', $category->color) == 'green') checked @endif id="green-radio" type="radio" value="green"
                    name="color"
            ...
            <div class="flex items-center me-4">
                <input @if (old('color', $category->color) == 'yellow') checked @endif id="yellow-radio" type="radio" value="yellow"
                    name="color"
            ...
            <div class="flex items-center me-4">
                <input @if (old('color', $category->color) == 'indigo') checked @endif id="indigo-radio" type="radio" value="indigo"
                    name="color"
            ...
            <div class="flex items-center me-4">
                <input @if (old('color', $category->color) == 'purple') checked @endif id="purple-radio" type="radio" value="purple"
                    name="color"
            ...
            <div class="flex items-center me-4">
                <input @if (old('color', $category->color) == 'pink') checked @endif id="pink-radio" type="radio" value="pink"
                    name="color"
